...
def main():
    ...
    process_data(cur, conn, filepath='s3://myspotifydb/data/tracks/A/A/A/', func=process_song_file)
    process_data(cur, conn, filepath='data/log_dataZ', func=process_log_file)
